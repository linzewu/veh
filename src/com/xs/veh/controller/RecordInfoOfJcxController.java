...
import com.xs.veh.manager.RecordInfoOfJcxManager;
...
@Modular(modelCode="RecordInfoOfJcx",modelName="检测线信息")
public class RecordInfoOfJcxController {
	
	@Resource(name = "RecordInfoOfJcxManager")
	private RecordInfoOfJcxManager recordInfoOfJcxManager;
	...
	public Map<String,Object> downloadInfo() throws RemoteException, UnsupportedEncodingException, DocumentException {
		...
		Document document = vehManager.queryws("18C02", param);
...
//		jo.put("gw9", "");
	...
	private List<Map<String, String>> getRows(RecordInfoOfJcx check) {
        ...
        String[] jcxSm = {"检验机构编号","检测线代号","检验机构名称","检测线名称","检测线类别","检测线控制方式","制动检测设备名称","制动检测设备型号","制动检测设备生产厂家","制动检测最少时间","制动检测方式","平板制式","单平板长度","平板间距","滚筒式制动台制式","滚筒式制动台停机方式","制动检测设备启用时间","制动检测设备检定有效期止","制动检测设备状态","灯光检测设备名称","灯光检测设备型号","灯光检测设备生产厂家","灯光检测最少时间","灯光检测方式","灯光检测是否有车身偏移修正功能","灯光检测设备启用时间","灯光检测设备检定有效期止"
        		,"灯光检测设备状态","速度检测设备名称","速度检测设备型号","速度检测设备生产厂家","速度检测最少时间","速度检测设备启用时间","速度检测设备检定有效期止","速度检测设备状态","侧滑检测设备名称","侧滑检测设备型号","侧滑检测设备生产厂家","侧滑检测最少时间","侧滑检测设备启用时间","侧滑检测设备检定有效期止","侧滑检测设备状态","称重设备名称","称重检测设备型号","称重检测设备生产厂家","称重检测最少时间","称重范围","称重检测设备检定有效期止","称重检测设备启用时间","称重检测设备状态","全线检测时间","工位1","工位2","工位3"
        		,"工位4","工位5","工位6","工位7","工位8","工位9","备注","发证机关","管理部门","更新日期","制动检验设备编号","制动检验设备检定/校准证书编号","灯光检验设备编号","灯光检测设备检定/校准证书标号","速度检验设备编号","速度检验设备检定/校准证书标号","侧滑检验设备编号","侧滑检验设备检定/校准证书编号","称重检验设备编号","称重检验设备检定/校准证书编号","状态标记","暂停原因"};
        try {
