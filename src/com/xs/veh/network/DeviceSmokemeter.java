 ...
 *
 */
public class DeviceSmokemeter extends SimpleRead implements ICheckDevice {
	
	private AbstractDeviceSmokemeter ads;
	...
	public AbstractDeviceSmokemeter getDs() {
		return ads;
	}

	public void setDs(AbstractDeviceSmokemeter ads) {
		this.ads = ads;
	}
	...
	public void init() throws InstantiationException, IllegalAccessException, ClassNotFoundException {
		ads = (AbstractDeviceSmokemeter) Class.forName(this.getDevice().getDeviceDecode()).newInstance();
		ads.init(this);
	}

	@Override
	public String getDeviceSpringName() {
		return "deviceSmokemeter";
	}
