 ...
 *
 */
public class DeviceEGA extends SimpleRead implements ICheckDevice {
	
	private AbstractDeviceEGA ega;
	...
	public AbstractDeviceEGA getDs() {
		return ega;
	}

	public void setDs(AbstractDeviceEGA ega) {
		this.ega = ega;
	}
	...
	public void init() throws InstantiationException, IllegalAccessException, ClassNotFoundException {
		ega = (AbstractDeviceEGA) Class.forName(this.getDevice().getDeviceDecode()).newInstance();
		ega.init(this);
	}
