...
public abstract class AbstractDeviceTachometer extends AbstractDevice  {
	
	protected DeviceTachometer deviceTachometer;
	...
	public void init(DeviceTachometer deviceTachometer) {
		this.deviceTachometer = deviceTachometer;
	}
