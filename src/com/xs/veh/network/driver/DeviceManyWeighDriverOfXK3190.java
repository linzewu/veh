...
public class DeviceManyWeighDriverOfXK3190 extends AbstractDeviceManyWeigh {
	
	static Logger logger = Logger.getLogger(DeviceManyWeighDriverOfXK3190.class);
	...
	public void device2pc(byte[] ed) throws IOException {
		//super.device2pc(ed);
		if(ed.length==22) {
			String temp=new String(new byte[] {ed[12],ed[13],ed[14],ed[15],ed[16],ed[17],ed[18]});
			lszl = Integer.valueOf(temp)/10;
		}
