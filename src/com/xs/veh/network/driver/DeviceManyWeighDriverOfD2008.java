...
public class DeviceManyWeighDriverOfD2008 extends AbstractDeviceManyWeigh {
	
	static Logger logger = Logger.getLogger(DeviceManyWeighDriverOfD2008.class);
	...
	public void device2pc(byte[] ed) throws IOException {
		//super.device2pc(ed);
		if(ed[0]==0x02&&ed[ed.length-1]==0x03&&ed[1]==0x2B) {
			String temp=new String(new byte[] {ed[2],ed[3],ed[4],ed[5],ed[6],ed[7]});
